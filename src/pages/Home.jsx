...
function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 overflow-x-hidden">
      {/* Title */}
      <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 mb-4 sm:mb-6 lg:mb-8 text-center -mt-12">
        Welcome to Our Hospital
      </h1>

      {/* Image Carousel */}
      <div className="relative w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg mx-auto mb-4 sm:mb-6 lg:mb-8 mt-2">
        <img
          src={images[currentImageIndex]}
          alt={`Hospital Image ${currentImageIndex + 1}`}
          className="w-full h-58 sm:h-74 md:h-82 lg:h-90 object-cover rounded-lg shadow-md cursor-pointer"
          loading="lazy"
        />
        <button
          onClick={handlePrev}
